...
class RecentMessagesActivity : AppCompatActivity() {
    ...
    private val conversationIdsDb = databaseOf(Databases.CONVERSATION_IDS, applicationContext)
    private val messagesDatabase = databaseOf(Databases.MESSAGES, applicationContext)
    ...
    private fun listenForHelpers() {
        ...
        fun onChildAdded(conversationId : String) {
            ...
            createAndSendKeyPair(conversationId, HELPEE, applicationContext)
