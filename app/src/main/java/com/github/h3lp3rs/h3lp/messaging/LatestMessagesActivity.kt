...
class LatestMessagesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState : Bundle?) {
        ...
        emergencyId = bundle?.getString(EXTRA_EMERGENCY_KEY) ?: emergencyId
    ...
    class HelperConversation(private val conversationId : String, private val index : Int) :
        ...
        override fun bind(viewHolder : ViewHolder, position : Int) {
            viewHolder.itemView.textview_username.text = globalContext.getString(R.string.helper)
        }
